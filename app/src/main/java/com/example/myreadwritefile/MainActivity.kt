...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun saveFile(){
        when{
            binding.editTitle.text.toString().isEmpty() -> Toast.makeText(this, "Title harus diisi terlbeih dahulu", Toast.LENGTH_SHORT).show()
            binding.editFile.text.toString().isEmpty() -> Toast.makeText(this, "Title harus diisi terlbeih dahulu", Toast.LENGTH_SHORT).show()
            else -> {
